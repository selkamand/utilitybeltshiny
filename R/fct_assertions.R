...
#'
#' @inherit utilitybeltassertions::assert_that return
#' @export
assert_reactive <- function(object, msg = "")
{
  name_of_calling_function=utilitybeltassertions::get_calling_function()
  utilitybeltassertions::assert_that(shiny::is.reactive(object), msg = utilitybeltassertions::fmterror("[",name_of_calling_function,"] assert_reactive: The object [",
